...
public final class ExampleMod {
    ...
    public static void init(String loaderName) {
        ...
        // production mapping (SRG on Forge, intermediary on Fabric) — getPath() and getDescriptionId() — so a
        // broken reobf would throw NoSuchMethodError at runtime instead of silently "working".
        ...
        // Call into the embedded greetlib. Each loader jar carries greetlib via Jar-in-Jar, so this resolves
        // at runtime on both Forge and Fabric even though greetlib is a plain (non-mod) library.
        LOGGER.info("[{}] {}", MOD_ID, Greeter.greet(loaderName));
    }
}
